...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) {
			exception.addError("email", "field can't be empty");// mostra na tela caso voce tente salvar um novo																// departamento vazio
		}
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) {
			exception.addError("baseSalary", "field can't be empty");// mostra na tela caso voce tente salvar um novo																// departamento vazio
		}
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldMaxLength(txtname, 70); // permite que apenas 30 caracteres sejam escritos
	...
	public void updateFormatData() {
		...
		// pegando a data local da pessoa
